...
/// <summary>
/// Use this wrapper class for AxWFICALib.AxICAClient if you experience crashes as shown below.
/// These crashes occur in the Citrix ICACLient control, for example when a form with the control on it
/// is docked/undocked with the WeifenLuo DockPanelSuite (but theyre might be more cases where this happens)...
/// 
/// To use this wrapper, build your form as normally. Once happy, open the code for your forms designer and replace
...
///   at Connections.Forms.Conn.FrmConnectionCitrixWI.OnFontChanged(EventArgs e) in C:\prive\Connections\Connections\Forms\Conn\FrmConnectionCitrixWI.cs:line 1046
...
///   at Connections.Program.Main(String[] args) in C:\prive\Connections\Connections\Program.cs:line 115
/// 
/// </summary>
namespace AxICAClientWrapper
{
    public class AxICAClientWrapper : AxWFICALib.AxICAClient
    {
